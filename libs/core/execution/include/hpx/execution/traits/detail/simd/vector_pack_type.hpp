...
namespace hpx { namespace parallel { namespace traits {
    ...
    namespace detail {
        ...
        {
            typedef SIMD_NAMESPACE::fixed_size_simd<T, N> type;
        };
        ...
        struct vector_pack_type<T, 0, Abi>
        {
            typedef typename std::conditional<std::is_void<Abi>::value,
                SIMD_NAMESPACE::simd_abi::native<T>, Abi>::type abi_type;

            typedef SIMD_NAMESPACE::simd<T, abi_type> type;
        };
    ...
    struct vector_pack_mask_type<T,
        typename std::enable_if_t<SIMD_NAMESPACE::is_simd_v<T>>>
    {
