...
namespace hpx { namespace parallel { namespace traits {
    ///////////////////////////////////////////////////////////////////////////
    template <typename T>
    struct is_simd_pack<std::experimental::native_simd<T>> : std::true_type
    {
    };
    ...
    ///////////////////////////////////////////////////////////////////////////
    template <typename T>
    struct is_scalar_simd_pack<std::experimental::native_simd<T>>
      : std::false_type
    {
    };
    ...
    struct simd_pack_alignment<std::experimental::simd<T, Abi>>
    {
        static std::size_t const value = std::experimental::memory_alignment_v<
    ...
    template <typename T, typename Abi>
    struct simd_pack_size<std::experimental::simd<T, Abi>>
    {
        static std::size_t const value =
