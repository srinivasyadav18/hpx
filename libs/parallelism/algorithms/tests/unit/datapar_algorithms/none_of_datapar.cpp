...
void test_none_of()
{
    ...
    test_none_of(simdpar, IteratorTag());

    test_none_of_async(simd(task), IteratorTag());
    test_none_of_async(simdpar(task), IteratorTag());
}
...
void test_none_of_exception()
{
    ...
    test_none_of_exception(simdpar, IteratorTag());

    test_none_of_exception_async(simd(task), IteratorTag());
    test_none_of_exception_async(simdpar(task), IteratorTag());
}
...
void test_none_of_bad_alloc()
{
    ...
    test_none_of_bad_alloc(simdpar, IteratorTag());

    test_none_of_bad_alloc_async(simd(task), IteratorTag());
    test_none_of_bad_alloc_async(simdpar(task), IteratorTag());
}
