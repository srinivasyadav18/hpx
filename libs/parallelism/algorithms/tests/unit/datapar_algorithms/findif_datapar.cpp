...
void test_find_if()
{
    ...
    test_find_if(simdpar, IteratorTag());

    test_find_if_async(simd(task), IteratorTag());
    test_find_if_async(simdpar(task), IteratorTag());
}
...
void test_find_if_exception()
{
    ...
    test_find_if_exception(simdpar, IteratorTag());

    test_find_if_exception_async(simd(task), IteratorTag());
    test_find_if_exception_async(simdpar(task), IteratorTag());
}
...
void test_find_if_bad_alloc()
{
    ...
    test_find_if_bad_alloc(simdpar, IteratorTag());

    test_find_if_bad_alloc_async(simd(task), IteratorTag());
    test_find_if_bad_alloc_async(simdpar(task), IteratorTag());
}
