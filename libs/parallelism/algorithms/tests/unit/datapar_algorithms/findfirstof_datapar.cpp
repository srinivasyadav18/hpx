...
void test_find_first_of()
{
    ...
    test_find_first_of(simdpar, IteratorTag());

    test_find_first_of_async(simd(task), IteratorTag());
    test_find_first_of_async(simdpar(task), IteratorTag());
}
...
void test_find_first_of_exception()
{
    ...
    test_find_first_of_exception(simdpar, IteratorTag());

    test_find_first_of_exception_async(simd(task), IteratorTag());
    test_find_first_of_exception_async(simdpar(task), IteratorTag());
}
...
void test_find_first_of_bad_alloc()
{
    ...
    test_find_first_of_bad_alloc(simdpar, IteratorTag());

    test_find_first_of_bad_alloc_async(simd(task), IteratorTag());
    test_find_first_of_bad_alloc_async(simdpar(task), IteratorTag());
}
