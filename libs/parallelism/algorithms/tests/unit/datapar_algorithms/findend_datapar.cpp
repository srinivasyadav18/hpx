...
void test_find_end1()
{
    ...
    test_find_end1(simdpar, IteratorTag());

    test_find_end1_async(simd(task), IteratorTag());
    test_find_end1_async(simdpar(task), IteratorTag());
}
...
void test_find_end2()
{
    ...
    test_find_end2(simdpar, IteratorTag());

    test_find_end2_async(simd(task), IteratorTag());
    test_find_end2_async(simdpar(task), IteratorTag());
}
...
void test_find_end3()
{
    ...
    test_find_end3(simdpar, IteratorTag());

    test_find_end3_async(simd(task), IteratorTag());
    test_find_end3_async(simdpar(task), IteratorTag());
}
...
void test_find_end4()
{
    ...
    test_find_end4(simdpar, IteratorTag());

    test_find_end4_async(simd(task), IteratorTag());
    test_find_end4_async(simdpar(task), IteratorTag());
}
...
void test_find_end_exception()
{
    ...
    test_find_end_exception(simdpar, IteratorTag());

    test_find_end_exception_async(simd(task), IteratorTag());
    test_find_end_exception_async(simdpar(task), IteratorTag());
}
...
void test_find_end_bad_alloc()
{
    ...
    test_find_end_bad_alloc(simdpar, IteratorTag());

    test_find_end_bad_alloc_async(simd(task), IteratorTag());
    test_find_end_bad_alloc_async(simdpar(task), IteratorTag());
}
