...
void test_find_if_not()
{
    ...
    test_find_if_not(simdpar, IteratorTag());

    test_find_if_not_async(simd(task), IteratorTag());
    test_find_if_not_async(simdpar(task), IteratorTag());
}
...
void test_find_if_not_exception()
{
    ...
    test_find_if_not_exception(simdpar, IteratorTag());

    test_find_if_not_exception_async(simd(task), IteratorTag());
    test_find_if_not_exception_async(simdpar(task), IteratorTag());
}
...
void test_find_if_not_bad_alloc()
{
    ...
    test_find_if_not_bad_alloc(simdpar, IteratorTag());

    test_find_if_not_bad_alloc_async(simd(task), IteratorTag());
    test_find_if_not_bad_alloc_async(simdpar(task), IteratorTag());
}
