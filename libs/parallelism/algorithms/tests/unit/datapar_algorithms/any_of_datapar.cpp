...
void test_any_of()
{
    ...
    test_any_of(simdpar, IteratorTag());

    test_any_of_async(simd(task), IteratorTag());
    test_any_of_async(simdpar(task), IteratorTag());
}
...
void test_any_of_exception()
{
    ...
    test_any_of_exception(simdpar, IteratorTag());

    test_any_of_exception_async(simd(task), IteratorTag());
    test_any_of_exception_async(simdpar(task), IteratorTag());
}
...
void test_any_of_bad_alloc()
{
    ...
    test_any_of_bad_alloc(simdpar, IteratorTag());

    test_any_of_bad_alloc_async(simd(task), IteratorTag());
    test_any_of_bad_alloc_async(simdpar(task), IteratorTag());
}
