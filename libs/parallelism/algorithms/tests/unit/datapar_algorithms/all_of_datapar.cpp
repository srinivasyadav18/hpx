...
void test_all_of()
{
    ...
    test_all_of(simdpar, IteratorTag());
...
void test_all_of_exception()
{
    ...
    test_all_of_exception(simdpar, IteratorTag());

    test_all_of_exception_async(simd(task), IteratorTag());
    test_all_of_exception_async(simdpar(task), IteratorTag());
}
...
void test_all_of_bad_alloc()
{
    ...
    test_all_of_bad_alloc(simdpar, IteratorTag());

    test_all_of_bad_alloc_async(simd(task), IteratorTag());
    test_all_of_bad_alloc_async(simdpar(task), IteratorTag());
}
