...
void test_find()
{
    ...
    test_find(simdpar, IteratorTag());

    test_find_async(simd(task), IteratorTag());
    test_find_async(simdpar(task), IteratorTag());
}
...
void test_find_exception()
{
    ...
    test_find_exception(simdpar, IteratorTag());

    test_find_exception_async(simd(task), IteratorTag());
    test_find_exception_async(simdpar(task), IteratorTag());
}
...
void test_find_bad_alloc()
{
    ...
    test_find_bad_alloc(simdpar, IteratorTag());

    test_find_bad_alloc_async(simd(task), IteratorTag());
    test_find_bad_alloc_async(simdpar(task), IteratorTag());
}
