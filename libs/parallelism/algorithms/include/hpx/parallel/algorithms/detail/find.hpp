...
namespace hpx { namespace parallel { inline namespace v1 { namespace detail {
    ...
    struct sequential_find_end_t
      : hpx::functional::tag_fallback<sequential_find_end_t<ExPolicy>>
    {
    private:
        template <typename Iter1, typename Sent1, typename Iter2,
            typename Sent2, typename Pred, typename Proj1, typename Proj2>
        friend inline constexpr Iter1 tag_fallback_dispatch(
    ...
    struct sequential_find_first_of_t
      : hpx::functional::tag_fallback<sequential_find_first_of_t<ExPolicy>>
    {
        template <typename InIter1, typename InIter2, typename Pred,
            typename Proj1, typename Proj2>
        friend inline constexpr InIter1 tag_fallback_dispatch(
