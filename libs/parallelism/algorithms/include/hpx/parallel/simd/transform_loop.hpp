...
#if defined(HAVE_HAVE_CXX20_EXPERIMENTAL_SIMD)
...
namespace hpx { namespace parallel { namespace util {
    namespace detail {
        ...
        struct simd_transform_loop_n
        {
            typedef typename std::decay<Iterator>::type iterator_type;

            typedef typename traits::simd_pack_type<
            ...
            HPX_HOST_DEVICE HPX_FORCEINLINE static typename std::enable_if<
                iterators_simd_compatible<InIter, OutIter>::value &&
                    iterator_simd_compatible<InIter>::value &&
                    iterator_simd_compatible<OutIter>::value,
            ...
            call(InIter first, std::size_t count, OutIter dest, F&& f)
            {
                ...
                for (/* */;
                     ...
                     --len)
                {
                    simd_transform_loop_step::call1(f, first, dest);
                }
                ...
                {
                    simd_transform_loop_step::callv(f, first, dest);
                }
    ...
    {
        return detail::simd_transform_loop_n<Iter>::call(
    ...
    namespace detail {
        ///////////////////////////////////////////////////////////////////////
        template <typename Iterator>
        struct simd_transform_loop_n_ind
        {
            typedef typename std::decay<Iterator>::type iterator_type;
            ...
            call(InIter first, std::size_t count, OutIter dest, F&& f)
            {
                ...
                for (/* */;
                     ...
                     --len)
                {
                    simd_transform_loop_step_ind::call1(f, first, dest);
                }
                ...
                for (std::int64_t len_v = std::int64_t(len - (size + 1));
                     len_v > 0; len_v -= size, len -= size)
                {
                    simd_transform_loop_step_ind::callv(f, first, dest);
                }
    ...
    tag_invoke(hpx::parallel::util::transform_loop_n_ind_t<ExPolicy>, Iter it,
        std::size_t count, OutIter dest, F&& f)
    {
        return detail::simd_transform_loop_n_ind<Iter>::call(
            it, count, dest, std::forward<F>(f));
    }
    ...
    HPX_HOST_DEVICE
        ...
        tag_invoke(hpx::parallel::util::transform_loop_t,
            ...
            F&& f)
    {
        auto ret = detail::simd_transform_loop<IterB>::call(
    ...
    namespace detail {
        ///////////////////////////////////////////////////////////////////////
        template <typename Iterator>
        struct simd_transform_loop_ind
        {
            typedef typename std::decay<Iterator>::type iterator_type;
            typedef typename std::iterator_traits<iterator_type>::value_type
                value_type;
    ...
    HPX_HOST_DEVICE
        ...
        tag_invoke(hpx::parallel::util::transform_loop_ind_t,
            ...
            F&& f)
    {
        auto ret = detail::simd_transform_loop_ind<IterB>::call(
            it, end, dest, std::forward<F>(f));
    ...
    namespace detail {
        ...
        struct simd_transform_binary_loop_n
        {
            ...
            template <typename InIter1, typename InIter2, typename OutIter,
                typename F>
            HPX_HOST_DEVICE HPX_FORCEINLINE static typename std::enable_if<
                iterators_simd_compatible<InIter1, OutIter>::value &&
                    iterators_simd_compatible<InIter2, OutIter>::value &&
                ...
                OutIter dest, F&& f)
            {
                ...
                for (/* */;
                     ...
                     --len)
                {
                    simd_transform_loop_step::call1(f, first1, first2, dest);
                }
                ...
                for (std::int64_t len_v = std::int64_t(len - (size + 1));
                     len_v > 0; len_v -= size, len -= size)
                {
                    simd_transform_loop_step::callv(f, first1, first2, dest);
                }
    ...
    {
        return detail::simd_transform_binary_loop_n<InIter1, InIter2>::call(
            first1, count, first2, dest, std::forward<F>(f));
    }
    ...
    namespace detail {
        ///////////////////////////////////////////////////////////////////////
        template <typename Iter1, typename Iter2>
        struct simd_transform_binary_loop
        {
            typedef typename std::decay<Iter1>::type iterator1_type;
            ...
            {
                auto ret =
                    util::transform_binary_loop_n<hpx::execution::simd_policy>(
    ...
    {
        return detail::simd_transform_binary_loop<InIter1, InIter2>::call(
            first1, last1, first2, dest, std::forward<F>(f));
    }
