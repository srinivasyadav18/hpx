...
namespace hpx { namespace parallel { namespace util {
    ...
    namespace detail {
        ...
        ///////////////////////////////////////////////////////////////////////
        template <typename ExPolicy, typename Simd>
        HPX_HOST_DEVICE HPX_FORCEINLINE typename std::enable_if<
            hpx::is_simdpack_execution_policy<ExPolicy>::value,
            typename Simd::value_type>::type
        tag_invoke(hpx::parallel::util::detail::extract_value_t<ExPolicy>,
            Simd const& value)
        {
            static_assert(traits::is_scalar_simd_pack<Simd>::value,
                "this should be called with a scalar only");
            return value[0];
        }

        ///////////////////////////////////////////////////////////////////////
        template <typename ExPolicy, typename F, typename Simd>
        HPX_HOST_DEVICE HPX_FORCEINLINE typename std::enable_if<
            hpx::is_simdpack_execution_policy<ExPolicy>::value,
            typename traits::simd_pack_type<
                typename std::decay<Simd>::type::value_type, 1>::type>::type
        tag_invoke(hpx::parallel::util::detail::accumulate_values_t<ExPolicy>,
            F&& f, Simd const& value)
        {
            typedef typename std::decay<Simd>::type simd_type;
            typedef typename simd_type::value_type entry_type;
            ...
            return typename traits::simd_pack_type<entry_type, 1>::type(accum);
        }

        ///////////////////////////////////////////////////////////////////////
        template <typename ExPolicy, typename F, typename Simd, typename T>
        HPX_HOST_DEVICE HPX_FORCEINLINE typename std::enable_if<
            hpx::is_simdpack_execution_policy<ExPolicy>::value,
            typename traits::simd_pack_type<T, 1>::type>::type
        tag_invoke(hpx::parallel::util::detail::accumulate_values_t<ExPolicy>,
            F&& f, Simd const& value, T accum)
        {
            ...
            return typename traits::simd_pack_type<T, 1>::type(accum);
        }
        ...
        struct loop_optimization<Iter,
            typename std::enable_if<
                iterator_simd_compatible<Iter>::value>::type>
        {
            ...
            static bool call(Iter_ const& first, Sent_ const& last)
            {
                ...
                return traits::simd_pack_size<V>::value <=
        ...
        struct simd_loop
        {
            ...
            HPX_HOST_DEVICE HPX_FORCEINLINE static
                typename std::enable_if<iterator_simd_compatible<Begin>::value,
                    Begin>::type
                call(Begin first, End last, F&& f)
            {
                while (!is_data_aligned(first) && first != last)
                {
                    simd_loop_step<Begin>::call1(f, first);
                }

                static std::size_t constexpr size =
                    traits::simd_pack_size<V>::value;

                End const lastV = last - (size + 1);
                while (first < lastV)
                {
                    simd_loop_step<Begin>::callv(f, first);
                }
                ...
                call(Begin it, End end, F&& f)
            {
                while (it != end)
                {
                    simd_loop_step<Begin>::call1(f, it);
                }
                return it;
            }
        };
        ...
        struct simd_loop_ind
        {
                ...
                call(Begin first, End last, F&& f)
            {
                while (!is_data_aligned(first) && first != last)
                {
                    simd_loop_step_ind<Begin>::call1(f, first);
                }
                ...
                while (first < lastV)
                {
                    simd_loop_step_ind<Begin>::callv(f, first);
                }
                ...
                call(Begin it, End end, F&& f)
            {
                while (it != end)
                {
                    simd_loop_step_ind<Begin>::call1(f, it);
                }
                return it;
            }
        };
        ...
        struct simd_loop2<std::true_type, Iter1, Iter2>
        {
            template <typename InIter1, typename InIter2, typename F>
            HPX_HOST_DEVICE HPX_FORCEINLINE static typename std::enable_if<
                iterators_simd_compatible<InIter1, InIter2>::value &&
                    iterator_simd_compatible<InIter1>::value &&
                    iterator_simd_compatible<InIter2>::value,
            ...
            call(InIter1 it1, InIter1 last1, InIter2 it2, F&& f)
            {
                ...
                while (it1 < last1V)
                {
                    simd_loop_step2<InIter1, InIter2>::callv(f, it1, it2);
                }
        ...
        template <typename Iter1, typename Iter2>
        struct simd_loop2<std::false_type, Iter1, Iter2>
        {
            template <typename InIter1, typename InIter2, typename F>
        ...
        struct simd_loop_n
        {
            ...
            HPX_HOST_DEVICE HPX_FORCEINLINE static
                typename std::enable_if<iterator_simd_compatible<InIter>::value,
                    InIter>::type
                call(InIter first, std::size_t count, F&& f)
            {
                ...
                {
                    simd_loop_step<InIter>::call1(f, first);
                }
                ...
                {
                    simd_loop_step<InIter>::callv(f, first);
                }
            ...
            template <typename InIter, typename F>
            HPX_HOST_DEVICE HPX_FORCEINLINE static typename std::enable_if<
                !iterator_simd_compatible<InIter>::value, InIter>::type
            call(InIter first, std::size_t count, F&& f)
            {
                for (/* */; count != 0; --count)
                {
        ...
        struct simd_loop_n_ind
        {
                ...
                call(InIter first, std::size_t count, F&& f)
            {
                ...
                for (/* */; !detail::is_data_aligned(first) && len != 0; --len)
                {
                    simd_loop_step_ind<InIter>::call1(f, first);
                }
                ...
                for (std::int64_t len_v = std::int64_t(len - (size + 1));
                     len_v > 0; len_v -= size, len -= size)
                {
                    simd_loop_step_ind<InIter>::callv(f, first);
                }
    ...
    template <typename ExPolicy, typename F, typename Iter1, typename Iter2,
        typename U = typename std::enable_if<
            hpx::is_simdpack_execution_policy<ExPolicy>::value>::type>
    HPX_HOST_DEVICE HPX_FORCEINLINE auto tag_invoke(
        hpx::parallel::util::loop_step_t<ExPolicy>, std::false_type, F&& f,
        Iter1& it1, Iter2& it2)
        -> decltype(detail::simd_loop_step2<Iter1, Iter2>::call1(
            std::forward<F>(f), it1, it2))
    {
        return detail::simd_loop_step2<Iter1, Iter2>::call1(
            std::forward<F>(f), it1, it2);
    }
    ...
    HPX_HOST_DEVICE HPX_FORCEINLINE auto tag_invoke(
        ...
        Iter1& it1, Iter2& it2)
        -> decltype(detail::simd_loop_step2<Iter1, Iter2>::callv(
            std::forward<F>(f), it1, it2))
    {
        return detail::simd_loop_step2<Iter1, Iter2>::callv(
            std::forward<F>(f), it1, it2);
    }
    ...
    HPX_HOST_DEVICE HPX_FORCEINLINE typename std::enable_if<
        hpx::is_simdpack_execution_policy<ExPolicy>::value, bool>::type
    ...
    HPX_HOST_DEVICE HPX_FORCEINLINE Begin tag_invoke(
        ...
        End end, F&& f)
    {
        return detail::simd_loop<Begin>::call(begin, end, std::forward<F>(f));
    }
    ...
    HPX_HOST_DEVICE HPX_FORCEINLINE Begin tag_invoke(
        ...
        Begin begin, End end, F&& f)
    {
        return detail::simd_loop_ind<Begin>::call(
    ...
    {
        return detail::simd_loop2<VecOnly, Iter1, Iter2>::call(
    ...
    namespace detail {
        ...
        HPX_HOST_DEVICE HPX_FORCEINLINE constexpr typename std::enable_if<
            hpx::is_simdpack_execution_policy<ExPolicy>::value, Iter>::type
        tag_invoke(hpx::parallel::util::detail::loop_n_t<ExPolicy>, Iter it,
            std::size_t count, F&& f)
        {
            return hpx::parallel::util::detail::simd_loop_n<Iter>::call(
        ...
        tag_invoke(hpx::parallel::util::detail::loop_n_ind_t<ExPolicy>, Iter it,
            std::size_t count, F&& f)
        {
            return hpx::parallel::util::detail::simd_loop_n_ind<Iter>::call(
                it, count, std::forward<F>(f));
        }
    }    // namespace detail
