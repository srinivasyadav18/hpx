...
namespace hpx { namespace parallel { namespace util {
    ...
    struct copy_n_t final
      : hpx::functional::tag_fallback<copy_n_t<ExPolicy>>
    {
    private:
        template <typename InIter, typename OutIter>
        friend HPX_HOST_DEVICE HPX_FORCEINLINE constexpr in_out_result<InIter, OutIter>
    ...
    {
        return hpx::parallel::util::copy_n_t<ExPolicy>{}(
            first, count, dest);
    }
#endif
