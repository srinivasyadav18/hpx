...
namespace hpx { namespace parallel { inline namespace v1 { namespace detail {
    ...
    struct datapar_find
    {
        ...
        static inline constexpr void call(
    ...
    tag_dispatch(sequential_find_t<ExPolicy>, Iterator first, Sentinel last,
    ...
    tag_dispatch(sequential_find_t<ExPolicy>, std::size_t base_idx, FwdIter part_begin,
        std::size_t part_count, Token& tok, T const& val, Proj&& proj)
    {
        return datapar_find<ExPolicy>::call(base_idx, part_begin, part_count, tok,
    ...
    inline constexpr std::enable_if_t<
        hpx::is_vectorpack_execution_policy<ExPolicy>::value, void>
    tag_dispatch(sequential_find_if_t<ExPolicy>, std::size_t base_idx,
        FwdIter part_begin,
        std::size_t part_count, Token& tok, F&& op, Proj&& proj)
    {
        return datapar_find_if<ExPolicy>::call(base_idx, part_begin, part_count, tok,
            std::forward<F>(op), std::forward<Proj>(proj));
    }
    ///////////////////////////////////////////////////////////////////////////
    template <typename ExPolicy>
    ...
    inline constexpr std::enable_if_t<
        hpx::is_vectorpack_execution_policy<ExPolicy>::value, void>
    tag_dispatch(sequential_find_if_not_t<ExPolicy>, std::size_t base_idx,
        FwdIter part_begin,
        std::size_t part_count, Token& tok, F&& op, Proj&& proj)
    {
        return datapar_find_if_not<ExPolicy>::call(base_idx, part_begin, part_count, tok,
            std::forward<F>(op), std::forward<Proj>(proj));
    }
